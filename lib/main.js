...
module.exports = function (config) {
  ...
  tools.gulp.task('lint_js', function() {
    return tools.gulp.src('app/scripts/**/*.js, !app/scripts/**/*.min.js')
    .pipe(tools.jshint())
  ...
  tools.gulp.task('lint_scss', [], function() {
    ...
    return tools.gulp.src('app/styles/**/*.scss')
      .pipe(tools.cache('scsslint'))
      .pipe(tools.scsslint(css_config));
  });

  // Styles task
  tools.gulp.task('scss', ['lint_scss'], function() {
    return tools.gulp.src('./app/styles/app.scss')
      .pipe(tools.sourcemaps.init())
      .pipe(tools.sass())
      .pipe(tools.sourcemaps.write('./maps'))
      .pipe(tools.gulp.dest('./app/styles/css'));
  });

  tools.gulp.task('styles', ['clean_css', 'scss'], function() {
    return tools.gulp.src('./app/styles/css/app.css')
      .pipe(tools.uncss({
        html: tools.glob.sync('./app/views/**/*.html').concat(['./app/index.min.html', './app/index.min.html'])
      }))
  ...
  tools.gulp.task('html', ['clean_views', 'clean_indexes'], function() {
    ...
    return tools.gulp.src('app/views/**/*.html')
  ...
  tools.gulp.task('images', ['clean_img', 'svgstore'], function () {
    return tools.gulp.src('app/images/**/*')
      .pipe(tools.imagemin({
        progressive: true,
  ...
  tools.gulp.task('svgstore', function () {
    return tools.gulp.src('app/images/svg/*.svg')
      .pipe(tools.svgmin())
  ...
  // Dev task
  tools.gulp.task('dev', ['styles', 'html', 'images', 'browserify'], function (cb) {
    cb();
  });
