...
module.exports = function (config) {
  ...
  tools.gulp.task('svgstore_' + web_component_name, function () {
    return tools.gulp.src(web_component_root + '/app/images/svg/**/*.svg' , { base: web_component_root + '/app/images/svg' })
      .pipe(tools.svgmin())
  ...
  tools.gulp.task('watch_' + web_component_name, ['dev_' + web_component_name], function() {
    ...
    tools.gulp.watch([web_component_root + '/app/views/**/*.html', web_component_root + '/app/index.html', web_component_root + '/app/index.min.html'], [
